webpackJsonp([11],Array(226).concat([
/* 226 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sale = function (_React$Component) {
		...
		function Sale(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Sale).call(this, props));
			...
			value: function render() {
				...
				for (var i = 0; i < rentobjs.length; i++) {
					...
					images.push(_react2.default.createElement(
						_reactRouter.Link,
						{ key: '' + i, to: '/sale/details/' + rentobjs[i].id },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								null,
								'Price: ',
								rentobjs[i].actions.action[0].price,
								' euro'
							),
							' '
						)
